...
// Export the table to Google Drive. Adds a task to export.
Export.table.toDrive({
  collection: meanBGndvi, // The feature collection to export
  description: 'test_region_ndvi', // the file name
  folder: 'RemoteSensingWork', 
  //fileNamePrefix: , 
  fileFormat: 'CSV' // Extension
  }); 
  ```
